...
export const deepForEach = (obj,userFn,maxDepth=10) => {
...
export const olaToObject = (objLikeArray, allToStr=true )=>{
...
export const allBNToStr = (obj,maxDepth=8,keepNums=false) => {
  let rc = (vv, dep)=>{const currDep=dep+1;
